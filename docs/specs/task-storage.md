...
|----|------|----------|--------|
| `task-storage-1` | Project scaffolding and dependencies | 1h | pending |
| `task-storage-2` | Implement loadTasks and saveTasks | 2h | pending |
| `task-storage-3` | Implement getNextId and createTask | 1.5h | pending |

**Total:** 4.5 hours (within 4-6h appetite)
