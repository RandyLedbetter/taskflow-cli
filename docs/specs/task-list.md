...
|----|------|----------|--------|
| `task-list-1` | Create list command with filtering and formatting | 1.5h | pending |
| `task-list-2` | Wire up CLI routing for list command | 0.5h | pending |

**Total:** 2 hours (within 2-3h appetite)
