...
|----|------|----------|--------|
| `task-done-1` | Create done command with validation and output | 1h | ✅ done |
| `task-done-2` | Wire up CLI routing for done command | 0.5h | ✅ done |

**Total:** 1.5 hours (within 1-2h appetite) — **COMPLETE**
