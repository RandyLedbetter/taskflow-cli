...
|----|------|----------|--------|
| `task-add-1` | Create add command with argument parsing | 1.5h | pending |
| `task-add-2` | Wire up CLI routing and error handling | 1h | pending |

**Total:** 2.5 hours (within 2-3h appetite)
